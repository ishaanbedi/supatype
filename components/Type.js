        ...
        <>
            ...
            <section className={testEnded ? 'min-h-screen md:block bg-[#1B2430] blur-sm brightness-150 ' : 'min-h-screen md:block bg-[#1B2430]'}>
                ...
                <div className='my-4 space-x-4 text-center'>
                    ...
                    <Link href='/'>
                        <button
                            className="relative inline-flex items-center px-8 py-3 mt-2 overflow-hidden text-white border border-current rounded group  active:text-indigo-500 focus:outline-none focus:ring"
                        >
                            <span className="absolute right-0 transition-transform translate-x-full group-hover:-translate-x-4">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                    ...
                    <>
                        ...
                        >
                            <div className="relative w-auto my-6 mx-auto max-w-3xl">
                                {/*content*/}
                                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-[#51557E] outline-none focus:outline-none">
                                    {/*header*/}
                                    <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                                        <h3 className="text-3xl font-semibold text-[#D6D5A8]">
                                            Test Completed!
                                        </h3>
                                        <button
                                    ...
                                    <div className="flex items-center justify-end p-6 border-t border-solid border-slate-200 rounded-b">
                                        <Link href='/profile'>
                                            ...
                                            >
                                                ...
                                                <a className="relative inline-flex items-center px-8 py-3 overflow-hidden text-white bg-[#816797] rounded group active:bg-indigo-500 focus:outline-none focus:ring">
                                                    <span className="absolute right-0 transition-transform translate-x-full group-hover:-translate-x-4">
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
